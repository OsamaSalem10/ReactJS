  ...
  return (
    <>
      ...
      <nav
        ...
        className="navbar navbar-expand-lg navbar-light navbar-default p-0 p-sm-0 navbar-offcanvas-color "
      >
        <div className="container-fluid">
          <div
              ...
              <div>
                <ul className="navbar-nav align-items-center">
                  <li className="dropdown me-6 d-none d-lg-block">
                    ...
                    >
                      <svg
                        className="bi bi-text-left me-2"
                        fill="currentColor"
                        height="16"
                        viewBox="0 0 16 16"
                        width="16"
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="ms-3 lh-1">
                          <h6 className="mb-1">
                            Changelog
                            <span className="text-primary ms-1">v1.4.2</span>
                          </h6>
