          ...
          <tbody className="product-list">
            <tr>
                ...
                <div className="d-flex align-items-start align-items-md-center hover-effect-scale position-relative py-1">
                  ...
                  >
                    <img
                      ...
                      src="assets/img/account/products/13.jpg"
                    />
                  </div>
                  <div className="ps-2 ps-sm-3 ms-1">
                    ...
                    <div className="fs-xs text-nowrap d-md-none mt-2 mb-1">
                      <span className="text-body-secondary">License:</span>{" "}
                      <span className="license">Standard</span>
                    </div>
                    <div className="fs-xs text-nowrap d-md-none">
                      <span className="text-body-secondary">Date:</span> July
                      28, 2024
                    </div>
                    <button
                      ...
                      type="button"
                    >
                      <i className="bi-download animate-target fs-sm ms-n1 me-1" />
                      Download
                    </button>
                  </div>
                </div>
              ...
              <td className="d-none d-md-table-cell py-3">
                July 28, 2024
                <span className="date visually-hidden">1722164400</span>
              </td>
            ...
            <tr>
                ...
                <div className="d-flex align-items-start align-items-md-center hover-effect-scale position-relative py-1">
                  ...
                  >
                    <img
                      alt=""
                      className="hover-effect-target"
                      src="assets/img/account/products/14.jpg"
                    />
                  </div>
                  <div className="ps-2 ps-sm-3 ms-1">
                    <h6 className="product mb-2">
                    ...
                    <div className="fs-xs text-nowrap d-md-none">
                      <span className="text-body-secondary">Date:</span> July 5,
                      2024
                    </div>
                    <button
                      className="btn btn-sm btn-secondary rounded-pill animate-scale position-relative z-2 d-sm-none mt-3"
              ...
              <td className="d-none d-md-table-cell py-3">
                July 5, 2024
                <span className="date visually-hidden">1720177200</span>
              </td>
              <td className="d-none d-md-table-cell py-3">Standard</td>
              <td
                className="d-none d-sm-table-cell text-end py-3 ps-0 ps-sm-3 pe-0"
            ...
            <tr>
                ...
                <div className="d-flex align-items-start align-items-md-center hover-effect-scale position-relative py-1">
                  ...
                  >
                    <img
                      alt=""
                      className="hover-effect-target"
                      src="assets/img/account/products/15.jpg"
                    />
                  </div>
                  <div className="ps-2 ps-sm-3 ms-1">
                    <h6 className="product mb-2">
                    ...
                    <div className="fs-xs text-nowrap d-md-none mt-2 mb-1">
                      <span className="text-body-secondary">License:</span>{" "}
                      <span className="license">Extended</span>
                    </div>
                    <div className="fs-xs text-nowrap d-md-none">
                      <span className="text-body-secondary">Date:</span> May 30,
                      2024
                    </div>
                    <button
                      className="btn btn-sm btn-secondary rounded-pill animate-scale position-relative z-2 d-sm-none mt-3"
              ...
              <td className="d-none d-md-table-cell py-3">
                May 30, 2024
                <span className="date visually-hidden">1717066800</span>
              </td>
            ...
            <tr>
                ...
                <div className="d-flex align-items-start align-items-md-center hover-effect-scale position-relative py-1">
                  ...
                  >
                    <img
                      alt=""
                      className="hover-effect-target"
                      src="assets/img/account/products/16.jpg"
                    />
                  </div>
                  <div className="ps-2 ps-sm-3 ms-1">
                    <h6 className="product mb-2">
                    ...
                    <div className="fs-xs text-nowrap d-md-none">
                      <span className="text-body-secondary">Date:</span> April
                      19, 2024
                    </div>
                    <button
                      className="btn btn-sm btn-secondary rounded-pill animate-scale position-relative z-2 d-sm-none mt-3"
              ...
              <td className="d-none d-md-table-cell py-3">
                April 19, 2024
                <span className="date visually-hidden">1713524400</span>
              </td>
              <td className="d-none d-md-table-cell py-3">Standard</td>
              <td
                className="d-none d-sm-table-cell text-end py-3 ps-0 ps-sm-3 pe-0"
            ...
            <tr>
                ...
                <div className="d-flex align-items-start align-items-md-center hover-effect-scale position-relative py-1">
                  ...
                  >
                    <img
                      alt=""
                      className="hover-effect-target"
                      src="assets/img/account/products/17.jpg"
                    />
                  </div>
                  <div className="ps-2 ps-sm-3 ms-1">
                    <h6 className="product mb-2">
              ...
              <td className="d-none d-md-table-cell py-3">
                April 12, 2024
                <span className="date visually-hidden">1712919600</span>
              </td>
              <td className="d-none d-md-table-cell py-3">Extended</td>
              <td
                className="d-none d-sm-table-cell text-end py-3 ps-0 ps-sm-3 pe-0"
            ...
            <tr>
                ...
                <div className="d-flex align-items-start align-items-md-center hover-effect-scale position-relative py-1">
                  ...
                  >
                    <img
                      alt=""
                      className="hover-effect-target"
                      src="assets/img/account/products/18.jpg"
                    />
                  </div>
                  <div className="ps-2 ps-sm-3 ms-1">
                    <h6 className="product mb-2">
                    ...
                    <div className="fs-xs text-nowrap d-md-none">
                      <span className="text-body-secondary">Date:</span> March
                      3, 2024
                    </div>
                    <button
                      className="btn btn-sm btn-secondary rounded-pill animate-scale position-relative z-2 d-sm-none mt-3"
              ...
              <td className="d-none d-md-table-cell py-3">
                March 3, 2024
                <span className="date visually-hidden">1709467200</span>
              </td>
              <td className="d-none d-md-table-cell py-3">Standard</td>
              <td
                className="d-none d-sm-table-cell text-end py-3 ps-0 ps-sm-3 pe-0"
