  ...
  return (
    <aside className="col-lg-3 ">
      ...
      <div
        ...
        id="accountSidebar"
      >
        <div className="d-none d-lg-block  pt-lg-2" />
        ...
        <div className="offcanvas-body d-block pt-2 pt-lg-4 pb-lg-0">
          <nav className="list-group list-group-borderless">
            <Link
              className={`list-group-item list-group-item-action d-flex align-items-center rounded-pill  ${location.pathname === '/' ? 'pe-none active' : ''}`}
              to="/"
            >
            ...
            <Link
              className={`list-group-item list-group-item-action d-flex align-items-center rounded-pill ${location.pathname === '/products' ? 'pe-none active' : ''}`}
              to="/products"
            >
            ...
            <Link
              className={`list-group-item list-group-item-action d-flex align-items-center rounded-pill ${location.pathname === '/sales' ? 'pe-none active' : ''}`}
              to="/sales"
            >
            ...
            <Link
              className={`list-group-item list-group-item-action d-flex align-items-center rounded-pill ${location.pathname === '/payouts' ? 'pe-none active' : ''}`}
              to="/payouts"
            >
          ...
          <nav className="list-group list-group-borderless">
            <Link
              className={`list-group-item list-group-item-action d-flex align-items-center rounded-pill ${location.pathname === '/purchases' ? 'pe-none active' : ''}`}
              to="/purchases"
            >
            ...
            <Link
              className={`list-group-item list-group-item-action d-flex align-items-center rounded-pill ${location.pathname === '/favorites' ? 'pe-none active' : ''}`}
              to="/favorites"
            >
            ...
            <Link
              className={`list-group-item list-group-item-action d-flex align-items-center rounded-pill ${location.pathname === '/settings' ? 'pe-none active' : ''}`}
              to="/settings"
            >
