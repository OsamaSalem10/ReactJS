export const Settings = () => {
  return (
    <section className="py-5">
      <h1 className="h6 pb-1 pb-sm-2 pb-md-3">Settings</h1>
      <div>
  ...
  <div className="tab-content">
    <div
      ...
      <div className="d-flex align-items-start align-items-sm-center pb-3 mb-3">
        ...
        <div className="ps-3 ps-sm-4">
          <p
            ...
            Your profile picture will appear on your profile and listings. PNG
            or JPG no bigger than 500px wide and tall.
          </p>
          <button
      ...
      <form className="needs-validation" noValidate>
        <div className="row row-cols-1 row-cols-sm-2 g-4 mb-4">
          ...
          <div className="col">
            <label className="form-label fs-base" htmlFor="display-name">
              Display name
            </label>
            <input
        ...
        <div className="pb-2 mb-4">
          <div className="form-check fs-lg m-0">
            <input
              ...
              type="checkbox"
            />
            <label className="form-check-label fs-base" htmlFor="allow-contact">
    ...
    <div
      ...
      <form className="needs-validation" noValidate>
        <div className="row row-cols-1 row-cols-sm-2 g-4 mb-4">
          <div className="col">
            <label className="form-label fs-base" htmlFor="current-password">
              Current password
            </label>
        ...
        <div className="row row-cols-1 row-cols-sm-2 g-4 mb-4">
          <div className="col">
            <label className="form-label fs-base" htmlFor="new-password">
              New password{" "}
    ...
    <div
      ...
      <div className="vstack gap-4 pt-sm-1">
        ...
        <div className="form-check form-switch mb-0">
          <input className="form-check-input" id="surveys" type="checkbox" />
